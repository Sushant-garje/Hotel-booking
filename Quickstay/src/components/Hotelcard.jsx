...
function Hotelcard({room , index}) {
  ...
  return (
   <Link to={'/room/'+room._id} onClick={scrollTo(0,0)} key={room._id} className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0,0.5)]'>
    <img src={room.images[0]} alt=""/>
        ...
        <div className='p-4 pt-5'>
            <div className='flex items-center justify-between'>
                <p className='font-playfair text-xl font-medium text-gray-800'>{room.hotel[index].name}</p>
            ...
            <div className='flex items-center gap-1 text-sm'>
                ...
                <span>{room.hotel[index].address}</span>
            </div>
