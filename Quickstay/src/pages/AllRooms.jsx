        ...
        <div>
            ...
            {roomsDummyData.map((room,index)=>(
                <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                    <img onClick={()=>{navigate(`/rooms/${room._id}/${index}`); scrollTo(0,0)}} 
                    ...
                    <div className='md:w-1/2 flex flex-col gap-2'>
                        <p className='text-gray-500'>{room.hotel[index].city}</p>
                        <p onClick={()=>{navigate(`/rooms/${room._id}/${index}`); scrollTo(0,0)}} 
                        className='text-gray-800 text-3xl font-playfair cursor-pointer'>{room.hotel[index].name}</p>
